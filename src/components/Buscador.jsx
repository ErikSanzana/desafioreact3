...
function Buscador({ onBuscar }) { // Define el componente Buscador que recibe la función onBuscar como prop
  ...
  const handleInputChange = (event) => { // Define una función de manejo para el cambio en la entrada de búsqueda
  ...
  return (
    <div className="mb-3">
      <label htmlFor="busqueda" className="form-label">Buscar Colaborador</label>
      <input
        type="text"
